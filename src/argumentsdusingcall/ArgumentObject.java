...
public class ArgumentObject {
	...
	public static void main(String[] args) {
		...
		ArgumentObject argumentsPromitive3 = new ArgumentObject();
		argumentsPromitive3.first = 10;
		argumentsPromitive3.second = 20;
		System.out.println(ArgumentObject.test);	
	}

	private static void doeSomethingstatic() {
